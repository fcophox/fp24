                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 col-md-12 mb-12 mb-md-12 text-center">
                                <img src="assets/images/single/delivery/delivery400.png" alt="" className="singleimage"/>
                            </div>
                            <div className="col-lg-8 offset-lg-2 col-md-12 mb-12 mb-md-12">
                                <br/>
                                <p dangerouslySetInnerHTML={{__html : t("caseF.behance")}} />
                                <br/>
                                <br/>
                            </div> 
                            ...
                            <div className="col-lg-12 col-md-12 mb-12 mb-md-12 text-center">
                                <img src="../assets/images/single/delivery/delivery401.png" alt="" className="singleimage backgroundColorSingle"/>
                                <img src="../assets/images/single/delivery/delivery402.gif" alt="" className="singleimage backgroundColorSingle"/>
                                <img src="../assets/images/single/delivery/delivery403.png" alt="" className="singleimage backgroundColorSingle"/>
                            </div>
                            <div className="col-lg-8 offset-lg-2 col-md-12 mb-12 mb-md-12">
                                <p className="paragraph paragraphRow" dangerouslySetInnerHTML={{__html : t("caseF.paragraphI")}} />
                                <p className="paragraph paragraphRow" dangerouslySetInnerHTML={{__html : t("caseF.paragraphJ")}} />
                                <p className="paragraph paragraphRow" dangerouslySetInnerHTML={{__html : t("caseF.paragraphK")}} />
                            </div>
                            <div className="col-lg-12 col-md-12 mb-12 mb-md-12 text-center">
                                <img src="../assets/images/single/delivery/delivery404.gif" alt="" className="singlegif"/>
                            </div>
