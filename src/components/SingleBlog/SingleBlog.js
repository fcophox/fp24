...
export class SingleBlog extends Component {
  ...
  mediumURL =
    "https://api.rss2json.com/v1/api.json?rss_url=https://medium.com/feed/@fcophox"; 
    componentDidMount() {
  ...
  render() {
    ...
    if(this.state.singlePost){
     post =( <>
      ...
      <div className={c.content}  dangerouslySetInnerHTML={{ __html:this.state.singlePost.content}}></div>
      </>
     )
    }
